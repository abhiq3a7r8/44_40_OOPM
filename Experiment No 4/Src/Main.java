        ...
        do {
            ...
            switch (choice) {
                case 1:
                    if (currentCustomerCount < cust_array.length) {
                        ...
                        if (extendedwstat.equalsIgnoreCase("Y")){
                            ...
                            cust_array[currentCustomerCount]=new Customer(currentCustomerCount,gender,name,phone_no,email_id,extended_warranty_duration);
                        }
                        else if(extendedwstat.equalsIgnoreCase("N")){
                            cust_array[currentCustomerCount]=new Customer(currentCustomerCount,gender,name,phone_no,email_id);
                        }
                ...
                case 10:
                    ...
                    device_array [timer - 1].setTurnedOn(false);
                    System.out.println("Timer duration:");
                    int time = scanner.nextInt();
                    device_array [timer - 1].setTimer(time);
                    break;
